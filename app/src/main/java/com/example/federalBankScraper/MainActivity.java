package com.example.federalBankScraper;
...
import com.example.federalBankScraper.Services.FederalRecorderService;

import java.util.List;

import com.example.federalBankScraper.Utils.Config;
import com.example.federalBankScraper.Utils.SharedData;
import com.example.FederalBankScraper.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isAccessibilityServiceEnabled(this, FederalRecorderService.class)) {
            showAccessibilityDialog();
        }

        Intent serviceIntent = new Intent(this, FederalRecorderService.class);
            ...
            handler.postDelayed(() -> {
                ...
                runOnUiThread(() -> {
                    ...
                    if (!isAccessibilityServiceEnabled(this, FederalRecorderService.class)) {
                        ...
                        serviceIntent = new Intent(this, FederalRecorderService.class);
                        startService(serviceIntent);
                    }
                });
